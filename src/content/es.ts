...
export const es: SiteCopy = {
  ...
  pages: {
    ...
    stats: {
      ...
      reproduceTitle: 'Comprueba tú mismo cada cifra',
      reproduceIntro:
        'Cada cifra de esta página viene de una llamada pública, sin clave y de solo lectura. Aquí está cada una, tal cual la hacemos. Pega cualquiera en una terminal.',
      reproduceField: 'El número está en',
      reproduceNote:
        'Se generan a partir de las mismas direcciones y endpoints que usa la propia página, así que no pueden dejar de coincidir en silencio. Si alguna contradice lo que ves arriba, la página está mal y queremos saberlo.',
      reproduceLabels: {
        price: 'Precio',
        marketCap: 'Capitalización',
        liquidity: 'Liquidez',
        volume: 'Volumen 24 h',
        holders: 'Número de holders',
        burned: 'Tokens quemados',
        supply: 'Suministro total',
        owner: 'Quién puede cambiar el contrato',
        trades: 'Operaciones recientes',
        holderList: 'Los mayores holders',
      },
      ...
      holderTableNote: 'Leído del explorador el {date}. Cada fila enlaza a la dirección.',
      holderAddress: 'Dirección',
      holderWhat: 'Qué es',
      holderTokens: 'Tokens',
      holderShare: 'Porcentaje del suministro',
      holderKinds: {
        burn: 'Quemado',
    ...
    pfp: {
      ...
      backupTitle: 'Lleva tu colección a otro navegador',
      backupIntro:
        'Lo que has sacado se guarda solo en este navegador, así que borrarlo o cambiar de móvil lo pierde. Copia el código, guárdalo, y pégalo aquí en el otro dispositivo.',
      backupCopy: 'Copiar mi código',
      backupRestore: 'Restaurar desde un código',
      backupFieldLabel: 'Tu código de colección',
      backupPlaceholder: 'Pega aquí un código para restaurarlo',
      backupCopied: 'Copiado. Guárdalo en buen sitio.',
      backupSelected: 'Seleccionado — cópialo tú.',
      backupBad: 'Eso no es un código de colección.',
      backupRestored: 'Restaurado. Tienes {count} monedas.',
