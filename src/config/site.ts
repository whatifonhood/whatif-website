...
export const LINKS = {
  ...
  /** Listings, partnerships, press. The project's own mailbox. */
  email: 'whatifonrobinhood@gmail.com',
} as const;
...
export const TOKEN_SNAPSHOT = {
  ...
  priceUsd: 0.01188,
  marketCapUsd: 10_755_439,
  liquidityUsd: 483_571,
  volume24hUsd: 459_701,
  burnedTokens: 94_874_305,
  holders: 7450,
} as const;
