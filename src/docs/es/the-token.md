...
Lo único no estándar que llegó a hacer fue una ventana de restricción de lanzamiento que expiró de forma permanente unos 73 minutos después del despliegue, el 11 de julio de 2026. [La cadena](/es/docs/the-chain/) explica por qué esa ventana se cuenta en bloques de Ethereum y no en bloques de Robinhood Chain.
